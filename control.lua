local function create_chart_settings_signature()
  ...
  return table.concat({
    tostring(s["colorblind-pollution-enabled"].value), format_column(s["colorblind-pollution-color"].value),
    tostring(s["colorblind-nests-enabled"].value), format_column(s["colorblind-nests-color"].value),
  }, "|")
end
